// src/app/router.tsx
// Centralized route definitions (AGENTS.md section 13).
import { Routes, Route, Navigate, useNavigate, useLocation } from "react-router-dom";
import { useEffect, useState } from "react";
import { KageLandingPage } from "../pages/home/HomePage";
import { BidangPage } from "../pages/bidang/BidangPage";
import { ProfilDokumenPage } from "../pages/profil/ProfilDokumenPage";
...
function AppRoutes() {
  ...
  // Listen for navigation messages from the child iframe (kage.html)
  useEffect(() => {
